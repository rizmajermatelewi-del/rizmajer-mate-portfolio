...
/* Order matches the order the sections appear in App.jsx, so clicking down the
   ...
   place. Készségek and AI left the list on 2026-09-24, when both sections
   folded into the services catalogue.
...
export const NAV_LINKS = [
  ...
  { label: { hu: 'Szolgáltatások', en: 'Services' }, href: '#szolgaltatasok' },
