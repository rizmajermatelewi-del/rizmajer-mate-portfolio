...
**Client property** for AB Masszázs (not the portfolio). Separate Vercel project:
https://ab-masszazs.vercel.app/
...
This repository should be `rizmajermatelewi-del/ab-masszazs`. Until GitHub App
permissions allow creating it from the agent, the same tree may live on branch
`cursor/ab-masszazs-standalone-c187` of the portfolio repo for extract/push.
